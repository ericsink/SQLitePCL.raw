...
namespace SQLitePCL
{
	...
	static class NativeMethods
	{
		...
		static public void Setup(IGetFunctionPointer gf)
		{
			...
			sqlite3_vfs_register = (MyDelegateTypes.sqlite3_vfs_register) Load(gf, typeof(MyDelegateTypes.sqlite3_vfs_register));
			sqlite3_vfs_unregister = (MyDelegateTypes.sqlite3_vfs_unregister) Load(gf, typeof(MyDelegateTypes.sqlite3_vfs_unregister));
		}
		...
		public static MyDelegateTypes.sqlite3_vfs_register sqlite3_vfs_register;
		public static MyDelegateTypes.sqlite3_vfs_unregister sqlite3_vfs_unregister;
	...
	static class MyDelegateTypes
	{
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public unsafe delegate int sqlite3_vfs_register(IntPtr p, int def);

		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public unsafe delegate int sqlite3_vfs_unregister(IntPtr p);
