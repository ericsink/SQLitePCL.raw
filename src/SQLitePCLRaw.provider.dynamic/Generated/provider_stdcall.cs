...
namespace SQLitePCL
{
    ...
    public sealed class SQLite3Provider_StdCall : ISQLite3Provider
    {
	...
	static class MyDelegateTypes
	{
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate int sqlite3_db_readonly(sqlite3 db, IntPtr dbName);
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate int sqlite3_complete(IntPtr pSql);

		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate int sqlite3_compileoption_used(IntPtr pSql);

		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate IntPtr sqlite3_compileoption_get(int n);

		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate int sqlite3_table_column_metadata(sqlite3 db, IntPtr dbName, IntPtr tblName, IntPtr colName, out IntPtr ptrDataType, out IntPtr ptrCollSeq, out int notNull, out int primaryKey, out int autoInc);
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate int sqlite3_bind_text(sqlite3_stmt stmt, int index, IntPtr val, int nlen, IntPtr pvReserved);

		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate int sqlite3_bind_parameter_count(sqlite3_stmt stmt);

		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate int sqlite3_bind_parameter_index(sqlite3_stmt stmt, IntPtr strName);
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate void sqlite3_result_error(IntPtr context, IntPtr strErr, int nLen);
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate void sqlite3_result_text(IntPtr context, IntPtr val, int nLen, IntPtr pvReserved);
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate int sqlite3_create_collation(sqlite3 db, IntPtr strName, int nType, hook_handle pvUser, NativeMethods.callback_collation func);
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate int sqlite3_exec(sqlite3 db, IntPtr strSql, NativeMethods.callback_exec cb, hook_handle pvParam, out IntPtr errMsg);
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate sqlite3_backup sqlite3_backup_init(sqlite3 destDb, IntPtr zDestName, sqlite3 sourceDb, IntPtr zSourceName);
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate int sqlite3_wal_checkpoint(sqlite3 db, IntPtr dbName);

		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate int sqlite3_wal_checkpoint_v2(sqlite3 db, IntPtr dbName, int eMode, out int logSize, out int framesCheckPointed);
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate int sqlite3_create_function_v2(sqlite3 db, IntPtr strName, int nArgs, int nType, hook_handle pvUser, NativeMethods.callback_scalar_function func, NativeMethods.callback_agg_function_step fstep, NativeMethods.callback_agg_function_final ffinal, NativeMethods.callback_destroy fdestroy);
