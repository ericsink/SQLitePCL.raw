...
namespace SQLitePCL
{
	...
	static class MyDelegateTypes
	{
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate int sqlite3_bind_blob(sqlite3_stmt stmt, int index, IntPtr val, int nSize, IntPtr nTransient);
		...
		[UnmanagedFunctionPointer(CALLING_CONVENTION)]
		public delegate int sqlite3_blob_open(sqlite3 db, IntPtr sdb, IntPtr table, IntPtr col, long rowid, int flags, out sqlite3_blob blob);
